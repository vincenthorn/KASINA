...
// Emergency production fix for admin dashboard
const app = express();
const dbPool = new Pool({ connectionString: process.env.DATABASE_URL });

// Working production query
...
// Test the fix
getProductionUsers().then(data => {
  console.log('Emergency fix test successful:');
  console.log(`Total Users: ${data.totalUsers}`);
  console.log(`Freemium: ${data.freemiumUsers}, Premium: ${data.premiumUsers}, Admin: ${data.adminUsers}`);
