...
const BreathKasinaOrb: React.FC<BreathKasinaOrbProps> = ({ 
  ...
  const [sizeScale, setSizeScale] = useState(0.1); // Scale factor for min-max range (balanced for natural breath response)
  ...
  const [sizeMultiplier, setSizeMultiplier] = useState(0.8); // Start at 80% - Control the expansion range (balanced for smooth breath response)
