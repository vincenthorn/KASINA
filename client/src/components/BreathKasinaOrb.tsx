...
const BreathKasinaOrb: React.FC<BreathKasinaOrbProps> = ({ 
  ...
  const [sizeScale, setSizeScale] = useState(1.0); // Scale factor for min-max range (full scale for proper visibility)
  ...
  const [sizeMultiplier, setSizeMultiplier] = useState(0.6); // Start at 60% - Control the expansion range (balanced for natural breath response)
