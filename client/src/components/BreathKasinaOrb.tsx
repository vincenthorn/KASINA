...
const BreathKasinaOrb: React.FC<BreathKasinaOrbProps> = ({ 
  ...
  const [sizeScale, setSizeScale] = useState(0.2); // Scale factor for min-max range (original working value)
  ...
  const [sizeMultiplier, setSizeMultiplier] = useState(1.5); // Start at 150% - Control the expansion range (original working value)
