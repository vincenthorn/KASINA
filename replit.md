...
- June 19, 2025: Fixed breath kasina sizing issue - restored original size multiplier range from 5%-500% back to proper 10%-80% range, reduced BASE_MAX_SIZE from 6000px to 300px and immersion cap from 1200px to 150px, eliminated giant kasina appearance in Color Kasinas during breath mode
