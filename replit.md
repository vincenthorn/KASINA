...
Changelog:
- June 27, 2025: Updated Earth kasina with darker terra cotta appearance and removed rotation in Visual mode. Changed from #CD853F to #A0522D base color with darker gradient palette (deep browns to warm earth tones). Earth kasina now remains stationary in Visual mode to reduce distraction while maintaining smooth terra cotta shader in both Visual and Breath modes.
