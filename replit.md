...
Changelog:
- June 25, 2025: Fixed Space and Light kasina shaders to render as perfect spheres. Replaced UV-based flat effects with proper normal-based 3D lighting. Space kasina now has subtle sparkle effects while maintaining spherical appearance. Light kasina features rim lighting and pulsing glow effects. Resolved elemental kasina background color issue by removing immersion background spheres and fixing Three.js clear color overrides.
