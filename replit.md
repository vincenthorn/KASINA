...
- June 19, 2025: Fixed breath kasina sizing issue - restored original size multiplier range from 5%-500% back to proper 10%-80% range, corrected BASE_MAX_SIZE to 1200px and immersion cap to 600px based on original scaling configuration, eliminated giant kasina appearance while maintaining proper breath kasina expansion range
